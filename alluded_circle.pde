...
Line random_cross_screen_line() {
 ...
 int rand = (int)random(6);
  switch(rand) {
    case 0:
      return new Line(western_vector(), northern_vector(), color(126,126,181));
    case 1:
      return new Line(northern_vector(), eastern_vector(), color(126,126,181));
    case 2:
      return new Line(eastern_vector(), southern_vector(), color(126,126,181));
    case 3:
      return new Line(southern_vector(), western_vector(), color(126,126,181));
    case 4:
      return new Line(western_vector(), eastern_vector(), color(126,126,181));
    case 5:
      return new Line(northern_vector(), southern_vector(), color(126,126,181));
  }
  // Comment out the top switch to allow for straight up random lines.
  return new Line(random_bounded_vector(), random_bounded_vector(), color(126,126,181));
}
...
Line random_line_from_existing(Line other) {
  ...
  switch(rand) {
    case 0:
      return new Line(start, northern_vector(), color(126,126,181));
    case 1:
      return new Line(start, eastern_vector(), color(83,83,151));
    case 2:
      return new Line(start, southern_vector(), color(53,53,124));
    case 3:
      return new Line(start, western_vector(), color(126,126,181));
  }
